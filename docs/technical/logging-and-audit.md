...
Voor nieuwe exports bindt manifest schema 2 de minimale CSV/XLSX, lichte
zakelijke CSV/XLSX, volledige CSV/XLSX en lege reserve aan één atomische
outputset. De lichte CSV wordt inhoudelijk opnieuw geprojecteerd uit de
gecontroleerde KVK-/bronrijen; van alle drie XLSX-bestanden worden pad, status,
grootte en hash gecontroleerd. Dit geldt ook voor `PARTIAL`; historische
schema-1-sets met vijf bestanden blijven auditbaar. De XLSX-cellen worden
niet afzonderlijk met de CSV vergeleken. Zie
