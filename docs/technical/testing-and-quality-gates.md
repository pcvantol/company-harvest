...
voor nieuwe wijzigingen daarom `NOT_TESTED`, ook al bevat de historische
releasekwalificatie van `v0.1.0` bewijs voor een bredere matrix. De lokale
Apple-Siliconcontrole gebruikt Python 3.14.
