...
| CH-PREKVK-007 | Brede master blijft intact; expliciete, herzienbare filter vóór KVK met school/ANBI/no-hint/holding/stichting/bank/fonds/kerk/partijcriteria | `pre_kvk_filter.py`, ADR-007, RD-009 | [offline volledige meting](../measurements/20260919-pre-kvk-filter.md), criterium- en regressietests; [read-only naamsvariantenanalyse](../measurements/20260919-pre-kvk-name-variants.md), geen extra filter geïmplementeerd |
