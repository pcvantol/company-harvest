...
| CH-DIST-002 | Publieke GitHub Release-asset | ADR-004 | Alleen `v2.0.0` is nog gepubliceerd; [anonieme byte-identieke v2.0.0-herdownload](../releases/20260919-v2.0.0-evidence.md); oudere release ingetrokken onder CH-2026-09-19-029 |
...
| CH-PREKVK-007 | Brede master blijft intact; expliciete, herzienbare filter vóór KVK met school/ANBI/no-hint/holding/stichting/bank/fonds/kerk/partijcriteria | `pre_kvk_filter.py`, ADR-007/011, RD-009 | [offline volledige meting](../measurements/20260919-pre-kvk-filter.md), criterium-, partitie- en regressietests; [read-only naamsvariantenanalyse](../measurements/20260919-pre-kvk-name-variants.md), geen extra filter geïmplementeerd |
