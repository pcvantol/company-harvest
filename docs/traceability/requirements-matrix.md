...
| CH-PREKVK-001 | Een vijfbronnenmaster mag alleen uit vijf full-scope, byte- en evidencegebonden bronoutputs ontstaan | `pre_kvk._source_inputs`, ADR-005 | 88 tests, echte vierbronnengate; Wikidata 429 verhindert master |
