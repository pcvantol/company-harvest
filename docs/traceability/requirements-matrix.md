...
| CH-DIST-002 | Publieke GitHub Release-asset | ADR-004 | `v1.0.0` en `v2.0.0` gepubliceerd; [anonieme byte-identieke v2.0.0-herdownload](../releases/20260919-v2.0.0-evidence.md) |
